...
# Load the Excel file
file_path = r"C:\Users\carso\Documents\July\comparisons.xlsx"
...
def fuzzy_match(product, choices, threshold=80):
    match, score = process.extractOne(product, choices, scorer=fuzz.ratio)
...
with pd.ExcelWriter(file_path, engine='openpyxl', mode='a') as writer:
    sheet2_df.to_excel(writer, sheet_name='Comparison_Result', index=False)

print("Comparison completed and saved in 'Comparison_Result2' sheet.")
